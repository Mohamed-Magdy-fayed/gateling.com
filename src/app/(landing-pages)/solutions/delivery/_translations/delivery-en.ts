export default {
  solutionsDeliveryPage: {
    ...
    heading:
      "Delivery App Software Built for Underserved Towns, Not Just Big Cities",
    subheading:
    ...
    heroSecondary: "See the ba2olak Case Study",

    problemEyebrow: "The Problem",
    problemHeading: "Why Standard Delivery Apps Skip Smaller Towns",
    problemSubheading:
    ...
    proofEyebrow: "Proven in the Field",
    proofHeading: "How We Built This for ba2olak",
    proofSubheading:
    ...
    faq1Q: "How long does it take to build a delivery marketplace app?",
    faq1A:
    ...
    faq2Q: "Does the app support cash on delivery?",
    faq2A:
    ...
    faq3Q: "Can one app handle both customers and delivery drivers?",
    faq3A:
    ...
    faq4Q: "Is the platform fully bilingual and Arabic-first?",
    faq4A:
