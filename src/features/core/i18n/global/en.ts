...
export default {
  ...
  blocks: {
    ...
    videoLandscape: "Landscape (16:9)",
    videoPortrait: "Portrait (9:16)",
    image: "Image",
    video: "Video",
    ...
    roiEmbedDescription:
      "Renders the live ROI calculator. Pre-fill the starting values for this business and choose whether to keep the call-to-action.",
    roiShowCta: "Show call-to-action button",
    roiTeamSize: "Initial team size",
    roiHoursPerWeek: "Initial manual hours per person / week",
    roiHourlyRate: "Initial hourly cost per person",
    roiCurrency: "Currency",
