...
export default {
  sales: {
    ...
    demoTime: "موعد العرض التوضيحي",
    demoTimeRequired: "العرض التوضيحي المجدول يحتاج إلى موعد.",
    demoMeeting: "اجتماع العرض التوضيحي",
    demoMeetingHint:
      "شارك الرابط مع العميل المحتمل عبر واتساب. روابط المضيف تُنشأ عند كل نقرة.",
